...
| Campo then Orden | `of config` audits CLIs; `of config set --contestant MODEL EFFORT` (peers). `of init --campo`; `of campo settle` pins ORDER. Host does not appoint. Same branch + commit = shared context. Pack. |
