...
| any residual MISSING (`running`) | `of status` / `of resume` already print the live `PULSE` + a `speak` line — quote one `PULSE` line to the user and do not claim done; no manual `of pulse` |
