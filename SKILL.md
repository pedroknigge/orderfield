...
| Campo then Orden | `of config set --contestant MODEL EFFORT` once. `of init --campo` launches and pins. Host does not appoint. Same branch + commit = shared context. c1=session. |
