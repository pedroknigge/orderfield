...
| oversized residual (collect/status/resume) | cite handle (path+size+head/tail; ≥10KiB). Full file on disk — read path, do not paste. Keep `OF_EVIDENCE_RECEIPT`. Wave-end roles read paths |
