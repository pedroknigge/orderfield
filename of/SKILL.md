---
name: of
description: v0.6.5 — Alias for the orderfield contract kernel. Use when the user invokes /of or orderfield, an existing .orderfield/ORDER.json must be resumed, or a genuine multi-slice / multi-writer wave needs a disk-backed plan. Do not trigger for a harness name or one ordinary subagent.
license: MIT
metadata:
  version: "0.6.5"
  alias-of: orderfield
