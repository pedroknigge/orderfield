...
After a successful `of phase`, `of next-wave` is the next step. The just-integrated wave stays eligible; do not integrate `--recompute` that completed wave. Follow the sibling.
