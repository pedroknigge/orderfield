...
**Date:** 2026-08-31
**Scope:** project
**Intent:** release-line 0.6.2 CLI command-group split (VERSION/docs/CHANGELOG/claims agree; not a new regime)
**Out:** root
**Auditor:** leader (docs vs symbols after 0.6.2 cli package split)
**Code rev:** VERSION `0.6.2` / `scripts/of.py` + `scripts/of/` + `scripts/of_adapters.py`
