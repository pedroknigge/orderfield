...
**Date:** 2026-08-31
**Scope:** project
**Intent:** release-line 0.6.3 protocol learnings (`of learn`; VERSION/docs/CHANGELOG/claims agree; not a new regime)
**Out:** root
**Auditor:** leader (docs vs symbols after 0.6.3 `of learn`)
**Code rev:** VERSION `0.6.3` / `scripts/of.py` + `scripts/of/` + `scripts/of_adapters.py`
