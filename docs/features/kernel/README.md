...
The kernel grew from 0.3.2 through 0.7.3. The physics stayed a method. No new regime.
...
**Status:** Introduced by `0.3.2`, current in `0.7.3` · **Code:** [`scripts/of.py`](../../../scripts/of.py), [`scripts/of/`](../../../scripts/of/), [`scripts/of_adapters.py`](../../../scripts/of_adapters.py), [`schemas/`](../../../schemas/)
