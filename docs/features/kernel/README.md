...
The kernel grew from 0.3.2 through 0.7.8. The physics stayed a method. No new regime.
...
**Status:** Introduced by `0.3.2`, current in `0.7.8` · **Code:** [`scripts/of.py`](../../../scripts/of.py), [`scripts/of/`](../../../scripts/of/), [`scripts/of_adapters.py`](../../../scripts/of_adapters.py), [`schemas/`](../../../schemas/)
...
- `of eval` runs recovery fixtures under `evals/recovery/` (including mission-rewrite, contract-close, slogan-evidence, pack-exclusivity); `--strict`, `--kernel`, `--list`. Eval steps may assert stderr.
