...
> Hub: [AGENTS.md](../AGENTS.md) · Install: [README.md](../README.md#install) (SHA-256 pin → first close; unpinned npx is not trusted) · One sitting: [docs/demo/mortal-install.md](demo/mortal-install.md)
