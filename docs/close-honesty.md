...
Same turn as `--checklist`: leftover field `of learn` notes and reportable errors are a HITL ask (appendix **Wave-end / pre-close surplus**). Not auto-promote-all. Not a close gate.
