...
class DoctorCommand(unittest.TestCase):
    ...
    def test_doctor_reports_path_not_auth_and_kernel_checks(self) -> None:
        ...
        self.assertIn("PATH is not auth, credentials, or session authority", out)
        self.assertIn("not readiness", out)
...
class OfEvalRecovery(unittest.TestCase):
    ...
    def test_recovery_evals_pass(self) -> None:
        ...
        self.assertIn("PASS recovery/cross-field-pack-roster", r.stdout)
        ...
        self.assertIn("PASS recovery/cursor-tier-model", r.stdout)
        self.assertIn("PASS recovery/wave-report-quality-gate", r.stdout)
        self.assertIn("PASS recovery/midflight-amend", r.stdout)
        self.assertIn("PASS recovery/multi-wave-residual", r.stdout)
        self.assertIn("PASS recovery/multi-wave-close-checklist", r.stdout)
    ...
    def test_eval_list(self) -> None:
        ...
        self.assertIn("cross-field-pack-roster", r.stdout)
        ...
        self.assertIn("cursor-tier-model", r.stdout)
        self.assertIn("wave-report-quality-gate", r.stdout)
        self.assertIn("midflight-amend", r.stdout)
        self.assertIn("multi-wave-residual", r.stdout)
        self.assertIn("multi-wave-close-checklist", r.stdout)
