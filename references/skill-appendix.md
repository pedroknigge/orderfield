...
- Do not close on self-praise. After a wave, ask consent for a fresh-context review packet (`adversary` / `verifier`) before close; never silent. Not a new close gate. Not `of merge`.
