...
- Packaging: VERSION 0.8.23; skill/alias description preview `v0.8.23. Use when…`. `install.sh` `DEFAULT_VERSION` in lockstep. Never rewrite v0.8.22 notes. Folded PRs `#295`–`#301`. `#293` already on main. `#281` / `#280` / `#291` / `#307` / `#308` / `#310` land on the same line (no bump).
