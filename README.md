...
<p align="center">
  <strong>v0.8.28</strong> · contract kernel · MIT · Python 3.11+ stdlib · <a href="https://agentskills.io">Agent Skill</a> interface
</p>
...
<p align="center">
  ...
  <a href="./SKILL.md"><img src="https://img.shields.io/badge/skill-0.8.28-0ea5e9?style=for-the-badge" alt="Skill version" /></a>
  <a href="./LICENSE"><img src="https://img.shields.io/badge/license-MIT-10b981?style=for-the-badge" alt="License" /></a>
</p>

Trusted path is tag-pinned **v0.8.28**, SHA-256 verified. Do not pipe unsigned `main`. From a checkout or a verified `install.sh`:

```bash
ORDERFIELD_REF=v0.8.28 bash install.sh --global --from-release
...
The glance above is the trusted pin (`ORDERFIELD_REF=v0.8.28` + `--from-release`). Tag-pinned GitHub release assets, SHA-256 verified. Do not pipe unsigned `main`. Unpinned `npx skills add` is **not the trusted** path. The full checksum-verify recipe (curl `releases/download` + `SHA256SUMS` + archive, then `ORDERFIELD_ARCHIVE` / `ORDERFIELD_SHA256SUMS`) lives in [PUBLISH.md](PUBLISH.md). Do not delete that ritual.
...
ORDERFIELD_REF=v0.8.28 bash install.sh --global --from-release --generic
