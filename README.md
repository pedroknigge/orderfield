...
<p align="center">
  <strong>v0.7.28</strong> · contract kernel · MIT · Python 3.11+ stdlib · <a href="https://agentskills.io">Agent Skill</a> interface
</p>

<p align="center">
  <a href="#install"><img src="https://img.shields.io/badge/install-npx%20skills-111827?style=for-the-badge" alt="Install" /></a>
  <a href="./SKILL.md"><img src="https://img.shields.io/badge/skill-0.7.28-0ea5e9?style=for-the-badge" alt="Skill version" /></a>
...
| `doctor` | local prereqs, ACTIVE/version/pack skew, adapter PATH, schemas, lock; PATH ≠ auth/ready |
| `retain` / `gc` | walk every field home; 7-day safe TTL; tree budget + HITL `--audit` / `--keep-field` / `--drop-field`; never copies transcripts |
