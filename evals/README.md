...
`--kernel` also runs `FieldAbandonedSignal`, `DurableMultiDayResume`, `MultiHarnessResidual`, `DoctorSkillVersionSkew`, `WaveReportQualityGate`, and `ThresholdStopSpawn`.
