...
| *(kernel unittest)* | — | SKILL / `/of` / appendix / adapters / SLAVE teach Orca `worker-stop` then `worker-release` after collect/abandon; `of worktree remove` if add was used; not a supervisor (`SkillOrcaWorkerTeardown`) |
