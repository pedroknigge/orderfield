...
If this repo uses Orderfield, every incoming agent (Claude Code, Codex, Cursor, OpenCode, Grok, Orca) obeys this:
...
Skill: look for `orderfield/SKILL.md` in the harness skill directories, `~/.agents/skills/orderfield/` (generic), or vendored in this repo. Unknown harnesses use `of spawn --adapter generic`.
