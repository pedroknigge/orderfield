...
| 0.8.15 collect unexpected keys name the legal home (`SchemaHomeHint`; `#215`); `validate_schema` subset honesty (`anyOf` / `maxLength` / `patternProperties`; `SchemaSubsetHonesty`; C-030) | documented |
