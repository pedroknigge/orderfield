...
| `field.py` WAL/view/learning split (SCOPE-GODSPLIT) | shipped (form polish) | `of.wal` / `of.learn` / `of.retain`; `field.py` re-exports public names and talks through `FieldWal` / `FieldLearnings` / `FieldRetain`. Not a product release. |
